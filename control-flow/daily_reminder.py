...
match priority:
    case "high":
        if time_bound == "yes":
            print(f"Reminder: '{description}' is a high priority task that requires immediate attention.")
        elif time_bound == "no":
            print(f"Reminder: '{description}' is a low priority task. Consider completing it when you have free time.")
    case "medium":
        if time_bound == "yes":
            print(f"Reminder: '{description}' is a medium priority task that requires immediate attention.")
        elif time_bound == "no":
            print(f"Reminder: '{description}' is a medium priority task. Consider completing it when you have free time.")
    case "low":
        if time_bound == "yes":
            print(f"Reminder: '{description}' is a low priority task that requires immediate attention.")
        elif time_bound == "no":
            print(f"Reminder: '{description}' is a low priority task. Consider completing it when you have free time.")